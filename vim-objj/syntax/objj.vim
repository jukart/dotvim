...
"       python_highlight_space_errors (default = 1)
"
...
if !exists("objj_highlight_space_errors")
  let objj_highlight_space_errors = 1
endif
...
if exists("objj_highlight_space_errors") && objj_highlight_space_errors != 0
  syn match objjSpaceError    "\s\+$" display
endif
