...
" jukart extensions start =====================================================
if !exists('jukart_disable')
  " Trailing space errors
  if exists("python_highlight_space_errors") && python_highlight_space_errors != 0
    " trailing whitespace also at empty line
  ...
  " Show column 80 as error (must not reach)
  syn match pythonSpaceError /\%<81v.\%>80v/

  " Show set_trace as error
  syn match pythonSpaceError /.*set_trace(.*\n/
  " Show storm debuging as error
  syn match pythonSpaceError /.*tracer.debug(.*\n/

  syn match LineProximity /\%<81v.\%>75v/
  syn match LineOverflow /\%>80v.\+/
endif
" jukart extensions end =====================================================
